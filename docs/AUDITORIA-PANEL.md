...
| **5** 🟡 | Citas hechas (015). **Auditoría y retención hechas (018)**: `audit_logs` de solo-escritura-por-función con las 5 acciones sensibles conectadas (factura emitida/cobrada, cobro, certificado, olvido RGPD), y retención automática nocturna (IPs 90 días, leads perdidos 2 años, HTML de correos 1 año). Quedan: **verificación en dos pasos (MFA)** — pedida por Manel, Supabase la soporta con TOTP —, pantalla para leer el registro de auditoría, RAT y declaración responsable. | Bajo | Casi |
